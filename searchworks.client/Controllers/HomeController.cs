...
namespace searchworks.client.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            /*
             Sever name :  svr-jcred-prod-zanorth-001.mysql.database.azure.com
             Username :ktodev@svr-jcred-prod-zanorth-001
             Password  :mrGw59Q8mdysGG
             Prod database name : j-creddb
             Dev database name  : j-creddb-dev
             QA database name   :  j-creddb-qa 
             */
