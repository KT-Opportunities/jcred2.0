function Export(filename, companyName, RegistrationNumber, searchType) {
    ...
    if (ExportButtonleft_co = document.getElementsByClassName('ExportButtonleft_col') == null) {
  ...
  /*  var table = document.getElementById('table');
    ...
    *//*PerInfo[0].style.marginBottom = "20px";*//*
    ...
    ExportButtonleft_col[0].style.display = "block";
    *//*ExportButtonleft_col[0].style.marginTop = "7%"*//*
    con2[0].style.flexDirection = "column";

    left_col[0].style.visibility = "collapse";

    not[0].style.visibility = "collapse";
    ...
    jsPDF: { unit: 'pt', format: 'letter', orientation: 'portrait' },
        ...
        pdf.setFontSize(10);
        pdf.setTextColor(150);
        pdf.text("Website: https://www.jcred.co.za", 400, 80);
    }).save();

    /*setTimeout(function () {
        for (var i; i < seaMore.length; i++) {
        ...
        seaMoreDeedsOffice[0].style.visibility = "visible";
        con2[0].style.flexDirection = "row";

        ExportButtonleft_col[0].style.display = "none";
        ExportButtonleft_col[0].style.marginTop = "0%"
